...
_SEARCH_PARSERS: dict[str, Any] = {
    ...
    "search_posts": parse_search_results_posts,
...
def parse_section(
    ...
    *,
    ...
    Args:
        ...
        entity_type: One of "person", "company", "search_people", "search_posts", "search_jobs", "job"
        include_raw: If True, attach source HTML to the model (debug mode)
    """
    parser = None

    if entity_type in ("search_people", "search_posts", "search_jobs"):
